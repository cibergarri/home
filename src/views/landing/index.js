    ...
    <Main>
      ...
      <Body>
        <MainContainer>
          ...
          <Paragraph>
            Having more expertise in the backend development -specially with
            {' '}
            <StyledNodeJsIcon />
            - but also targeting frontend technologies -as
            {' '}
            <StyledReactIcon />
            -
          </Paragraph>
          <Paragraph>
            In one of my -not so far away- past lifes I also worked with
            {' '}
          ...
          <Paragraph>
            Please, remember this site will be always under
            {' '}
