...
import {
  Header, CustomSwitch, CustomAppBar, CustomToolbar, Title, NightModeContainer, Blank, SVG, LinksContainer, Link, BackgroundImage, BackgroundTitle, BackgroundSubtitle
} from './style';
...
function CustomHeader() {
  ...
  return (
    <>
      ...
      <BackgroundImage>
        <BackgroundTitle>I ♥ coding</BackgroundTitle>
